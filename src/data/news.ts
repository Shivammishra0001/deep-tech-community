...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    domain: "governance",
    title: "EU AI Act compliance architecture: engineering risk management for high-risk systems",
    excerpt:
      "With enforcement milestones approaching, AI engineering teams are operationalizing risk management, model documentation, and continuous monitoring pipelines.",
    body: [
      "Regulatory mandates are transitioning from policy whitepapers to engineering requirements. The EU AI Act's enforcement framework establishes strict auditability standards for foundation models and high-risk AI deployments.",
      "Key engineering implications stand out: automated compliance logging, transparent model cards, data lineage tracking, and continuous post-market monitoring pipelines. Teams must demonstrate systemic risk mitigation across training datasets, fine-tuning protocols, and deployment environments.",
      "For our community, governance frameworks offer a technical blueprint. The tooling ecosystem spans open-source evaluation benchmarks, bias detection suites, and cryptographic audit logs.",
      "Our governance track hosted a hands-on workshop building automated risk assessment pipelines directly integrated into CI/CD release workflows.",
      "The path forward requires close collaboration between ML engineers, security leads, and legal ethicists to build verifiable safety architectures.",
    ],
    author: "Tomohiro Sato",
    authorRole: "AI Governance Lead",
    date: "Feb 04, 2026",
    readingTime: 6,
    tags: ["eu-ai-act", "governance", "risk-management", "compliance"],
  ...
  {
    slug: "algorithmic-risk-auditing-standards",
    domain: "governance",
    title: "Algorithmic audit frameworks & automated decision-tree transparency standards",
    excerpt:
      "Independent audit frameworks enable verifiable evaluations of autonomous decision systems before deployment in mission-critical environments.",
    body: [
      "As automated decision-making scales across healthcare, finance, and public policy, independent auditing frameworks provide essential safety guarantees.",
      "Our governance track collaborated on an open-source evaluation suite for algorithmic transparency. The framework evaluates decision-tree paths, feature attribution stability, and adversarial robustness across complex multi-agent systems.",
      "Engineering teams can integrate these auditing rules directly into continuous evaluation pipelines, ensuring real-time monitoring of model drift and safety boundary violations.",
      "Our community governance research circle is hosting an open demonstration of automated decision-tree verification tools.",
      "Building verifiable accountability into frontier models is how we ensure alignment with human intent.",
    ],
    author: "Ananya Iyer",
    authorRole: "Community Operations & AI Governance researcher",
    date: "Jan 06, 2026",
    readingTime: 6,
    tags: ["auditing", "transparency", "algorithmic-risk", "decision-trees"],
    image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1200&auto=format&fit=crop",
  },
];
