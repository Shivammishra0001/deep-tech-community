  ...
  return (
    <div className={cx("relative w-full rounded-2xl border border-neutral-800 bg-[#0A0A0A] p-6 sm:p-8 overflow-hidden shadow-2xl", className)}>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 font-sans text-xs sm:text-sm text-neutral-400 max-w-xl">
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="grid size-7 place-items-center rounded-lg border border-neutral-800 bg-neutral-900 text-neutral-300 transition-colors group-hover:border-neutral-600 group-hover:text-neutral-50">
                    <Icon className="size-4" />
                  </div>
                </div>
                <h4 className="mt-3 font-display text-sm sm:text-base font-bold text-neutral-200 group-hover:text-neutral-50">
                  {node.title}
                </h4>
              </div>

              <div className="mt-4 flex items-center justify-between border-t border-neutral-800/80 pt-3 font-mono text-[10px] text-neutral-500">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-neutral-800/80 pt-4 font-mono text-xs text-neutral-400">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1.5">
            <Lock className="size-3.5 text-neutral-400" /> Tamper-Proof Logs
          </span>
          <span className="flex items-center gap-1.5">
            <Network className="size-3.5 text-neutral-400" /> Multi-Agent Verification
          </span>
        </div>
        <span className="text-neutral-500">ISO/IEC 42001 & NIST AI RMF Compliant</span>
      </div>
    </div>
  );
}
