    ...
    <>
      ...
      <Container className="max-w-3xl py-8 sm:py-10">
        <Card className="space-y-8 text-sm leading-relaxed text-neutral-200">
          <section>
            <h2 className="font-display text-lg font-semibold text-primary">1. Membership & Code of Ethics</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-primary">2. Intellectual Property</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-primary">3. Responsible Research Conduct</h2>
            <p className="mt-2">
