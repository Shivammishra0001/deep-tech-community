...
import { RevealHeading, RevealVisual, RevealStagger, RevealItem, RevealText, Reveal } from "@/components/reveal";
  ...
  return (
    <>
      ...
      <Container className="pb-16">
        <RevealHeading><SectionHeading eyebrow="Governance & Ethics" title="Four Operating Principles" /></RevealHeading>
          ...
          {[
            ...
            return (
              <RevealItem key={p.title}>
                <Card hover className="group relative flex flex-col justify-between p-7">
                  <div>
