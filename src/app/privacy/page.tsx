...
export default function PrivacyPage() {
  return (
    <>
      <PageHero eyebrow="Community Governance" title="Privacy Policy" description="Direct, transparent data handling practices. Last updated January 2026." />
      <Container className="max-w-3xl py-8 sm:py-10">
        <Card className="space-y-8 text-sm leading-relaxed text-neutral-200">
          <section>
            <h2 className="font-display text-lg font-semibold text-primary">1. Data Collection Scope</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-primary">2. Usage &amp; Communication</h2>
            <p className="mt-2">
